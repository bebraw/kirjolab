...
- A bounded resource-context presenter synchronizes the evidence, annotation,
  ...
  canonical page update from each viewer page change and applies workspace and
  private-PDF replacement through its bound route owners while leaving concrete
...
- [x] Preview scroll and each PDF's page, scroll, and focused annotation survive
      tab switches.
- [x] Preview and standalone Library readers can hide and restore global
      navigation while keeping their context strip available.
...
- [x] The assistant presenter binds authoring manuscript, passage resolution,
