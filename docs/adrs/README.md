...
| ADR                                                                           | Status      | Summary                                                                                              |
| ----------------------------------------------------------------------------- | ----------- | ---------------------------------------------------------------------------------------------------- |
| [ADR-133](./accepted/ADR-133-resolve-optional-project-entry-files.md)         | Accepted    | Resolve an omitted project entry to `main.md` or the first Markdown path, then persist its identity. |
