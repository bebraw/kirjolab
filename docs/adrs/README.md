...
| ADR                                                                                  | Status   | Summary                                                                      |
| ------------------------------------------------------------------------------------ | -------- | ---------------------------------------------------------------------------- |
| [ADR-240](./proposed/ADR-240-deduplicate-pdf-bytes-across-libraries-and-projects.md) | Proposed | Store one verified PDF byte object across Libraries and projects.            |
