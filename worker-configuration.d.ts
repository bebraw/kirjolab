/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12f222a1d0090fd16d56cc84fd505e2f)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	AUTH_MODE: "access";
	ARTIFACT_ANALYSIS_MODE: "enabled";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "ARTIFACT_ANALYSIS_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "CROSSREF_MAILTO" | "GITHUB_APP_ID" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_SLUG">> {}
}
declare module "*.css" {
	const value: string;
