/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4949d832897f6efb92a687f2a88ddc7b)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "AUTH_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "CROSSREF_MAILTO">
  > {}
}
declare module "*.css" {
  const value: string;
