/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4fe2af0e5d511ba1b8674fc5d1997b77)
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: "DocumentRoom" | "WorkspaceCatalog" | "WorkspaceAccess";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD">> {}
}
declare module "*.css" {
  const value: string;
