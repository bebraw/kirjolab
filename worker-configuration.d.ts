/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2856e791fe450200570d53e39b5bf3fd)
// Runtime types generated with workerd@1.20260710.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	PAPERS: R2Bucket;
	ARTIFACT_ANALYSIS_QUEUE: Queue;
	ARTIFACT_ANALYSIS_BROWSER: BrowserRun;
	AI: Ai;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	AUTH_MODE: "access";
	ACCESS_TEAM_DOMAIN: "https://survivejs.cloudflareaccess.com";
	ACCESS_AUD: "312f732f4a74d422f56b4c8a39b8da4883245a93b72b61eb8e9c890cbb4f4a90";
	CROSSREF_MAILTO: "";
	GITHUB_APP_ID: "4313375";
	GITHUB_APP_CLIENT_ID: "Iv23liaAOSbgwDC77xsz";
	GITHUB_APP_SLUG: "kirjolab-sync-bebraw";
	KIRJOLAB_MODEL_UPSTREAM: string;
	KIRJOLAB_MODEL_COMPANION_ORIGIN: string;
	OPENALEX_API_KEY: string;
	DOCUMENT_ROOMS: DurableObjectNamespace<import("./src/worker").DocumentRoom>;
	WORKSPACE_CATALOGS: DurableObjectNamespace<import("./src/worker").WorkspaceCatalog>;
	REVIEW_CATALOGS: DurableObjectNamespace<import("./src/worker").ReviewCatalog>;
	PROJECT_TEMPLATE_CATALOGS: DurableObjectNamespace<import("./src/worker").ProjectTemplateCatalog>;
	REVIEW_STUDIES: DurableObjectNamespace<import("./src/worker").ReviewStudy>;
	REVIEW_ACCESS: DurableObjectNamespace<import("./src/worker").ReviewAccess>;
	WORKSPACE_ACCESS: DurableObjectNamespace<import("./src/worker").WorkspaceAccess>;
	REFERENCE_LIBRARIES: DurableObjectNamespace<import("./src/worker").ReferenceLibrary>;
	BACKUP_COORDINATOR: DurableObjectNamespace<import("./src/worker").BackupCoordinator>;
	BACKUP_RECOVERIES: DurableObjectNamespace<import("./src/worker").BackupRecovery>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DocumentRoom" | "WorkspaceCatalog" | "WorkspaceAccess" | "ReferenceLibrary" | "BackupCoordinator" | "BackupRecovery" | "ProjectTemplateCatalog" | "ReviewStudy" | "ReviewCatalog" | "ReviewAccess";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "CROSSREF_MAILTO" | "GITHUB_APP_ID" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_SLUG" | "KIRJOLAB_MODEL_UPSTREAM" | "KIRJOLAB_MODEL_COMPANION_ORIGIN" | "OPENALEX_API_KEY">> {}
}
declare module "*.css" {
	const value: string;
