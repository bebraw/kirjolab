...
describe("review screening", () => {
  ...
  it("parses attributed records and gates full text on title-and-abstract inclusion", () => {
    const snapshot = parseReviewScreeningSnapshot({
      ...
      counts: { titleAbstractPending: 0, titleAbstractIncluded: 1, fullTextPending: 1, fullTextIncluded: 0, conflicts: 0 },
    });
    ...
    expect(() =>
      parseReviewScreeningSnapshot({
        ...
        reviewersPerStage: 1,
        blinded: false,
        records: [{ record: null, titleAbstract: {}, fullText: {} }],
        counts: { titleAbstractPending: 0, titleAbstractIncluded: 0, fullTextPending: 0, fullTextIncluded: 0, conflicts: 0 },
      }),
    ...
    expect(() =>
      parseReviewScreeningSnapshot({
        ...
        blinded: false,
        records: [],
        counts: { titleAbstractPending: -1, titleAbstractIncluded: 0, fullTextPending: 0, fullTextIncluded: 0, conflicts: 0 },
      }),
    ).toThrow("count");
  });
});
