  ...
  constructor(ctx: DurableObjectState, env: Env) {
    ...
    ctx.blockConcurrencyWhile(async () => {
      ...
      const migrationDependencies = {
        ...
        addAnchorColumns: (table: "passage_links" | "claim_passage_links") => this.#addAnchorColumns(table),
        backfillManuscriptAnchors: () => this.#backfillManuscriptAnchors(),
        reconcileBibliography: (source: string) => this.#reconcileBibliography(source),
