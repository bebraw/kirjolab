...
import { parseResearchQuestions, researchQuestionsPath, researchQuestionsTemplate } from "../../domain/manuscript/research-questions";
import {
  parseReviewerResponses,
  reviewerResponseLetter,
  reviewerResponsePath,
  reviewerResponseTemplate,
} from "../../domain/manuscript/reviewer-response";
