...
import { projectFileCollaborationTextName, type ProjectFile } from "../../domain/project/project-files";
import type { EditorPresenceRange } from "../collaboration/editor-presence";
import { LightDomElement } from "../platform/light-dom-controller";
import type { CitationContext, CitationInsertion } from "../citation/citations";
