...
import { researchDiaryPath, researchDiaryTemplate, summarizeResearchDiary } from "../../domain/manuscript/writing-workflows";
import type { WritingWorkflowDocument } from "../editor/writing-workflow-panel";
