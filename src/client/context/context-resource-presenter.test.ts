...
import { createManuscriptAnchor, toManuscriptAnchorSelector } from "../../domain/manuscript/manuscript-anchor";
import type {
  BibliographicRecord,
  LibraryHighlight,
  LibraryPdfArtifact,
...
import type { AnnotationResource, PdfResource, ProjectReferenceLink, WorkspaceSnapshot } from "../../domain/workspace/workspace";
