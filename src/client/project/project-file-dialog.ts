...
import type { CollaborationSocket } from "../collaboration/collaboration-socket";
import type { ContextApplicationOwners, ContextResourcePresenter } from "../context/context-resource-presenter";
...
import type { RestoredOfflineWorkspace } from "../platform/offline-workspace";
import type {
  ReferenceLibraryWorkspace,
  ReferenceLibraryWorkspaceOwners,
  StandaloneLibraryOwners,
} from "../library/reference-library-workspace";
import type { WorkspacePreview, WorkspacePreviewProjectOwners } from "../preview/workspace-preview";
import { loadWorkspaceSnapshot, WorkspaceAccessError } from "../workspace/workspace-snapshot-client";
