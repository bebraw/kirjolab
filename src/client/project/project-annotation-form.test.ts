...
import type { AnnotationResource, PublicationResource } from "../../domain/workspace/workspace";
import { ProjectAnnotationForm, type ProjectHighlightTool } from "./project-annotation-form";
import { PublicationIntakePanel, type PublicationIntakeAction } from "../publication/publication-intake-panel";
