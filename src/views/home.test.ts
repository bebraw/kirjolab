...
describe("renderHomePage", () => {
  it("renders the complete scholarly workspace shell", () => {
    ...
    expect(html).toContain('<workspace-catalog-panel id="workspace-catalog-panel">');
    ...
    expect(html).toContain('class="pdf-reader-status" id="paper-status" role="status" aria-live="polite" data-state="busy"');
    ...
    expect(html).toContain('<claim-list-panel id="claim-list-panel">');
    ...
    expect(html).toContain('id="project-map-nodes" role="group" aria-label="Project resources"');
    ...
    expect(html.match(/class="ui-icon rail-action-icon"/gu)).toHaveLength(3);
    ...
    expect(html).toContain('<citation-network-panel id="citation-network-panel">');
    ...
    expect(html).toContain('<assistant-generation-presenter id="assistant-generation-presenter"></assistant-generation-presenter>');
  ...
  it("renders a project-free library shell", () => {
    ...
    expect(html).toContain('id="paper-links"');
    expect(html).not.toContain('<h2 title="Private references and research material">Library</h2>');
  ...
  it("keeps Library intake, discovery, and tools compact", () => {
    ...
    expect(html).toContain('<reference-library-workspace class="contents" id="reference-library-workspace">');
