    ...
    <form class="review-study-content" id="review-protocol-form">
      ...
      <div class="review-study-grid">
        <div class="review-study-form-stack">
          ...
          <section class="review-study-card"><div class="review-study-card-heading"><div><p class="eyebrow">Extraction</p><h4>Typed data form</h4></div><small><code>Label | type | enum; values</code></small></div><textarea class="field font-mono" id="review-extraction-fields" rows="6" maxlength="40000" placeholder="Study design | string |&#10;Year | integer |&#10;Eligible | boolean |&#10;Method | enum | survey; experiment; case study"></textarea></section>
        </div>
