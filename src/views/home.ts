...
<dialog class="review-study-dialog ui-dialog" id="review-study-dialog">
  <div class="review-study-shell">
    ...
    <form class="review-study-content" id="review-protocol-form">
      ...
      <div class="review-study-grid">
        <div class="review-study-form-stack">
          ...
          <section class="review-study-card"><div class="review-study-card-heading"><div><p class="eyebrow">Extraction</p><h4>Typed data form</h4></div><small><code>Label | type | enum values | RQ ids</code></small></div><textarea class="field font-mono" id="review-extraction-fields" rows="6" maxlength="40000" placeholder="Study design | string | | rq1&#10;Year | integer | |&#10;Eligible | boolean | |&#10;Method | enum | survey; experiment; case study | rq1; rq2"></textarea></section>
        </div>
    ...
    <section class="review-screen-content" id="review-appraise-content" hidden><header class="review-screen-toolbar"><div><p class="eyebrow">Quality assessment</p><h3>Evidence-linked appraisal</h3><p>Every checklist answer requires an exact quotation and location.</p></div></header><div class="review-screen-list" id="review-appraise-list"><div class="empty-state">No full-text inclusions are ready for appraisal.</div></div><footer class="review-study-footer"><p id="review-appraise-status" role="status" aria-live="polite">Scores are derived from the frozen checklist.</p><div><button class="button-secondary" id="back-to-review-screen" type="button">Back to screening</button></div></footer></section>
