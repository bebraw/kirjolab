...
<dialog class="review-study-dialog ui-dialog" id="review-study-dialog">
  <div class="review-study-shell">
    ...
    <nav class="review-study-steps" aria-label="Review study stages">
      <button id="review-step-plan" type="button" aria-current="step">1. Plan</button><button id="review-step-search" type="button" disabled>2. Search</button><button id="review-step-screen" type="button" disabled>3. Screen</button><button type="button" disabled>4. Appraise</button><button type="button" disabled>5. Extract</button><button type="button" disabled>6. Synthesize</button><button type="button" disabled>7. Report</button>
    </nav>
