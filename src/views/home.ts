...
export function renderHomePage(
  ...
  const workspaceLayoutControl = renderWorkspaceLayoutControl(appMode);
  const contextTabs = renderContextTabs();
  return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<dialog class="reference-library-dialog ui-dialog" id="export-dialog">
    ...
    <dialog class="new-workspace-dialog ui-dialog" id="latex-import-dialog">
      <latex-import-panel id="latex-import-panel">
        <form class="p-5" id="latex-import-form">
          ...
          <div class="mt-5 border-t border-app-line pt-4" id="latex-import-preview" aria-live="polite"><p class="ui-status">Preview to inspect the converted Markdown and diagnostics.</p></div>
